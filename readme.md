...
This respository contains the software and models developed from the methods in "A Machine Learning Classification Model for Monitoring the Daily Physical Behaviour of Lower-Limb Amputees".
